...
\begin{wraptable}{r}{0.45\textwidth}
 ...
 \vspace{-0.5cm}
\end{wraptable}
asses the accuracy of the method. The excitation energies within any variant of
...
\Cref{tb:DoubleEx} summarizes the FSS results for a series of excitations that
...
orbitals. 
%In addition, for the case of molecular oxygen, we are able to recover
...
%identification of the degeneracy lifted states. 
